...
####a) Are the universitys students distributed in the desired way? Perform the relevant hypothesis test and give your conclusion.
```{r}
...
####c) Compute intervals for pairwise comparisons based on Tukeys honest significant differences. Describe the optimal salinity level(s).
